...
@WebServlet("/food")
public class foodJava extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int foodCost=0;
		int cost=0;
		String food1=request.getParameter("foodId1")+"1";
		String food2=request.getParameter("foodId2")+"2";
		String food3=request.getParameter("foodId3")+"3";
		String food4=request.getParameter("foodId4")+"4";
		String food5=request.getParameter("foodId5")+"5";
		...
		String foodName="";
				...
				if(food1.equals("food11")) {
					foodCost+=100;
					foodName+="1 Coca Cola + 1 medium Popcorn;<br> ";
				}				
				if(food2.equals("food22")) {
					foodCost+=150;
					foodName+="1 Coca Cola + 1 Small Fries + 1 Veg Burger;<br> ";
				}
				if(food3.equals("food33")) {
					foodCost+=200;
					foodName+="1 Coca Cola + 2 Medium fries + 2 Veg Burger;<br> ";
				}
				if(food4.equals("food44")) {
					foodCost+=80;
					foodName+="MilkShake; <br>";
				}
				if(food5.equals("food55")) {
					foodCost+=60;
					foodName+="Ice-cream;<br> ";
				}
				//System.out.println("food cost and name :"+foodCost+";   "+foodName);
	  ...
	  //System.out.println("movieName, genere, derector and time :"+name+", "+genere+", "+ director +", "+duration);
	         ...
	         cost=cost*number;
	   // System.out.println("cost for single ticket : 	"+cost);
	   //System.out.println("Total cost for "+number+" tickets : 	"+cost);
	         ...
	         int totalCost=cost+foodCost;
	          	...
	          	case 1:
	          		if(slot==1){
	          			...
	          			if(!m.bookNew(number)){
	          				...
	          				result += "<center><div style='border:1px solid black;border-radius:3px;width:600px;position: relative;top: 120px;'>"
	          						+ "<h2 style='background-color:rgb(185, 26, 26); padding:10px; margin:0px; color:white'>Tickets info</h2>"
	          						+ "<h3>Ticket Cost Rs." + cost + "</h3><hr>"
	          			...
	          			if(!m.bookNew(number)){
	              			...
	              			result += "<center><div style='border:1px solid black; border-radius:3px; width:600px; position:relative; top:120px;'>"
	          						+ "<h2 style='background-color:rgb(185, 26, 26); padding:10px; margin:0px; color:white'>Tickets info</h2><br/>"
	          ...
	          result+="</section></html>";
	          out.println(result);
	          result="<br><center><form action=payment method=post>"
	        		  +"<input type=submit value='process for Payment' id=proceedButton style='font-size:22px;'>"
	          		...
	          		+ "</form>"
	          +"<a href='movieMenu.jsp'><button id=backButton>Back</button></a></center>";
	          out.println(result);
		}catch(Exception e) {
